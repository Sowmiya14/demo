...
@section('title')Sri Shanmugha College of Pharmacy - Our Principal @endsection
        ...
        <div class="shell">
            <div class="range range-xs-center">
                ...
                <div class="cell-sm-8 text-left">
                    ...
                    <p class="offset-top-10">Principal Sri Shanmugha College of Pharmacy</p>
                    <div class="offset-top-15 offset-sm-top-30">
                    ...
                    <div class="offset-top-20">
                        <p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pharmacists comprise the third largest healthcare professionals in the world and pharmacy profession. Now, the role of pharmacists is expanding and now pharmacists are playing a role as a vital team member in the health care of patients. I am sure that, opportunities are awaiting for pharmacy graduates in and around India.<strong>Sri Shanmugha College of Pharmacy</strong>(SSCOP) offers Pharmacy Programmes and are <strong>approved by AICTE, PCI and The Tamilnadu Dr. MGR Medical University</strong>
                            <br><br>
